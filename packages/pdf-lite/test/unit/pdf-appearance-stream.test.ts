...
import { PdfAppearanceStream } from '../../src/graphics/pdf-appearance-stream'
        ...
        describe('Text Fitting', () => {
            ...
            describe('Single-line Text Fitting', () => {
                it('should create appearance stream for short text without scaling', () => {
                    const stream = PdfAppearanceStream.textField(
                        createContext({
                            value: 'Hi',
                        }),
                    )
            ...
            describe('PDF Content validation', () => {
                it('should generate properly structured PDF content', () => {
                    const stream =
                        PdfAppearanceStream.textField(createContext())
