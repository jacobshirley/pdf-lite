...
[pdf-lite](../../../../README.md) / [core/tokens/stream-chunk-token](../README.md) / PdfStreamChunkToken

# Class: PdfStreamChunkToken
...
> **new PdfStreamChunkToken**(`bytes`): `PdfStreamChunkToken`
