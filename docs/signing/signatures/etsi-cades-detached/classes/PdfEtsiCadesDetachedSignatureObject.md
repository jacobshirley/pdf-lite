...
[pdf-lite](../../../../README.md) / [signing/signatures/etsi-cades-detached](../README.md) / PdfEtsiCadesDetachedSignatureObject

# Class: PdfEtsiCadesDetachedSignatureObject
...
> **new PdfEtsiCadesDetachedSignatureObject**(`options`): `PdfEtsiCadesDetachedSignatureObject`
...
> **additionalCertificates**: [`ByteArray`](../../../../types/type-aliases/ByteArray.md)[]
...
> `optional` **algorithm**: `AsymmetricEncryptionAlgorithmParams`
...
> `optional` **policyDocument**: [`SignaturePolicyDocument`](../../../types/type-aliases/SignaturePolicyDocument.md)
...
> **privateKey**: [`ByteArray`](../../../../types/type-aliases/ByteArray.md)
...
> `optional` **revocationInfo**: [`RevocationInfo`](../../../types/type-aliases/RevocationInfo.md) \| `"fetch"`
...
> `optional` **timeStampAuthority**: [`TimeStampAuthority`](../../../types/type-aliases/TimeStampAuthority.md)
...
[`PdfSignatureObject`](../../base/classes/PdfSignatureObject.md).[`toJSON`](../../base/classes/PdfSignatureObject.md#tojson)
