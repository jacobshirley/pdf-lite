...
[pdf-lite](../../../../README.md) / [core/objects/pdf-trailer](../README.md) / PdfTrailer
...
> **new PdfTrailer**(`entries`): `PdfTrailer`

#### Parameters

##### entries

[`PdfTrailerEntries`](../type-aliases/PdfTrailerEntries.md) | [`PdfDictionary`](../../pdf-dictionary/classes/PdfDictionary.md)\<[`PdfTrailerEntries`](../type-aliases/PdfTrailerEntries.md)\>
...
> **dict**: [`PdfTrailerDictionary`](../type-aliases/PdfTrailerDictionary.md)
