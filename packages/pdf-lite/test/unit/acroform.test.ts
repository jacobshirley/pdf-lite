...
import { PdfAcroForm } from '../../src/acroform/pdf-acro-form.js'
...
describe('AcroForm', () => {
    it('should be able to read AcroForm field values', async () => {
        ...
        const hasAcroForm = document.acroform
        expect(hasAcroForm).toBeDefined()
...
describe('AcroForm Parent/Child Field Inheritance', () => {
    ...
    it('should handle Opt as object reference (currently fails)', () => {
        ...
        const optionsObject = new PdfIndirectObject({
