...
[pdf-lite](../../../README.md) / [signing/types](../README.md) / PdfSignatureSubType

# Type Alias: PdfSignatureSubType

> **PdfSignatureSubType** = `"adbe.pkcs7.detached"` \| `"adbe.pkcs7.sha1"` \| `"adbe.x509.rsa_sha1"` \| `"ETSI.CAdES.detached"` \| `"ETSI.RFC3161"`
