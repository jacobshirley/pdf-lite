...
import { PdfGraphics } from '../../../src/acroform/appearance/pdf-graphics.js'
...
describe('PdfPageManager', () => {
    ...
    describe('integration with content and serialization', () => {
        it('should create a PDF document with pages and content', async () => {
            ...
            const content1 = new PdfGraphics()
            content1.beginText()
            ...
            const content2 = new PdfGraphics()
            content2.beginText()
