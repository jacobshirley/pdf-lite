...
[pdf-lite](../../../../README.md) / [core/objects/pdf-xref-table](../README.md) / PdfXRefTableSectionHeader

# Class: PdfXRefTableSectionHeader
...
> **new PdfXRefTableSectionHeader**(`options`): `PdfXRefTableSectionHeader`
...
> **entryCount**: [`PdfNumber`](../../pdf-number/classes/PdfNumber.md)
...
> **startObjectNumber**: [`PdfNumber`](../../pdf-number/classes/PdfNumber.md)
