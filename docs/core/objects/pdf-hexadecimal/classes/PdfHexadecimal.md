...
[pdf-lite](../../../../README.md) / [core/objects/pdf-hexadecimal](../README.md) / PdfHexadecimal

# Class: PdfHexadecimal
...
> **get** **bytes**(): [`ByteArray`](../../../../types/type-aliases/ByteArray.md)
...
> **toHexBytes**(): [`ByteArray`](../../../../types/type-aliases/ByteArray.md)
...
> `protected` **tokenize**(): [`PdfHexadecimalToken`](../../../tokens/hexadecimal-token/classes/PdfHexadecimalToken.md)[]

Tokenizes the object into an array of PdfTokens

#### Returns

[`PdfHexadecimalToken`](../../../tokens/hexadecimal-token/classes/PdfHexadecimalToken.md)[]
...
> `static` **toHexadecimal**(`data`): `PdfHexadecimal`
