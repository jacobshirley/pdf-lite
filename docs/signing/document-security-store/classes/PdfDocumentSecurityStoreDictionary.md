...
[pdf-lite](../../../README.md) / [signing/document-security-store](../README.md) / PdfDocumentSecurityStoreDictionary

# Class: PdfDocumentSecurityStoreDictionary
...
> **new PdfDocumentSecurityStoreDictionary**(`entries?`): `PdfDocumentSecurityStoreDictionary`
...
`K` _extends_ `"Type"` \| `"VRI"` \| `"OCSPs"` \| `"CRLs"` \| `"Certs"`
...
> **keys**(): [`PdfName`](../../../core/objects/pdf-name/classes/PdfName.md)\<`string`\>[]

#### Returns

[`PdfName`](../../../core/objects/pdf-name/classes/PdfName.md)\<`string`\>[]

#### Inherited from

[`PdfDictionary`](../../../core/objects/pdf-dictionary/classes/PdfDictionary.md).[`keys`](../../../core/objects/pdf-dictionary/classes/PdfDictionary.md#keys)
