...
[pdf-lite](../../../../README.md) / [acroform/xfa/pdf-xfa-data](../README.md) / PdfXfaData
...
> **new PdfXfaData**(`stream`): `PdfXfaData`
...
> **getFieldValue**(`name`): `string` \| `null`
...
[`XfaFieldData`](../interfaces/XfaFieldData.md)[]
