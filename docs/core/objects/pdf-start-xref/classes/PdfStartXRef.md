...
[pdf-lite](../../../../README.md) / [core/objects/pdf-start-xref](../README.md) / PdfStartXRef
...
> **new PdfStartXRef**(`offset`): `PdfStartXRef`
...
> **offset**: [`PdfNumber`](../../pdf-number/classes/PdfNumber.md)
