...
import { PdfContentStream } from '../../src/acroform/appearance/pdf-content-stream'
...
describe('PdfContentStream', () => {
    describe('PdfContentStream Text Measurement', () => {
        let graphics: PdfContentStream
