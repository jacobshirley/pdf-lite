...
[pdf-lite](../../../README.md) / [pdf/pdf-pages](../README.md) / PdfPages

# Class: PdfPages

## Extends

- [`PdfIndirectObject`](../../../core/objects/pdf-indirect-object/classes/PdfIndirectObject.md)\<`PdfPagesDictionary`\>

## Implements

- `Iterable`\<[`PdfPage`](../../pdf-page/classes/PdfPage.md)\>

## Constructors

### Constructor

> **new PdfPages**(`options?`): `PdfPages`
...
> **get** **kids**(): (`PdfPages` \| [`PdfPage`](../../pdf-page/classes/PdfPage.md))[]

##### Returns

(`PdfPages` \| [`PdfPage`](../../pdf-page/classes/PdfPage.md))[]
...
> **\[iterator\]**(): `Iterator`\<[`PdfPage`](../../pdf-page/classes/PdfPage.md)\>

#### Returns

`Iterator`\<[`PdfPage`](../../pdf-page/classes/PdfPage.md)\>
...
> **get**(`index`): [`PdfPage`](../../pdf-page/classes/PdfPage.md)
...
[`PdfPage`](../../pdf-page/classes/PdfPage.md)
...
> **toArray**(): [`PdfPage`](../../pdf-page/classes/PdfPage.md)[]
